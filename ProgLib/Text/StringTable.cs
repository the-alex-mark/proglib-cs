...
namespace ProgLib.Text
{
    public class StringTable
    {
        ...
        public StringTableOptions Options { get; protected set; }

        public StringTable(params String[] Columns) : this(new StringTableOptions { Columns = new List<String>(Columns) })
        {
        ...
        public StringTable(StringTableOptions Options)
        {

...
namespace ProgLib.Text.Encoding.Barcode.Symbologies
{
    /// <summary>
    ...
    class Interleaved2of5 : BarcodeCommon, IBarcode
    {
        ...
        private string Encode_Interleaved2of5()
        {
            ...
            if (Raw_Data.Length % 2 != (Encoded_Type == BarcodeType.Interleaved2of5_Mod10 ? 1 : 0))
            ...
            string result = "1010";
            string data = Raw_Data + (Encoded_Type == BarcodeType.Interleaved2of5_Mod10 ? CalculateMod10CheckDigit().ToString() : "");

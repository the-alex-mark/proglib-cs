...
{
    public class StringDataTableOptions
    {
        public IEnumerable<String> Columns { get; set; } = new List<String>();
        public Boolean EnableCount { get; set; } = true;
    }

    public enum StringDataTableFormat
    {
        Default = 0,
        MarkDown = 1,
        Alternative = 2,
    ...
    public class StringDataTable
    {
        ...
        public StringDataTableOptions Options { get; protected set; }

        public StringDataTable(params String[] Columns) : this(new StringDataTableOptions { Columns = new List<String>(Columns) })
        {

        }

        public StringDataTable(DataTable Table)
        {
            ...
            StringDataTable T = new StringDataTable(Columns.ToArray());
        ...
        public StringDataTable(StringDataTableOptions Options)
        {
        ...
        public static StringDataTable From<T>(IEnumerable<T> values)
        {
            var table = new StringDataTable();
        ...
        /// <returns></returns>
        public String Result(StringDataTableFormat format = StringDataTableFormat.Default)
        {
            String Table = "";

            switch (format)
            {
                case StringDataTableFormat.Default:
                    Table = ToString();
                    break;
                case StringDataTableFormat.MarkDown:
                    Table = ToMarkDownString();
                    break;
                case StringDataTableFormat.Alternative:
                    Table = ToStringAlternative();
                    break;
                case StringDataTableFormat.Minimal:

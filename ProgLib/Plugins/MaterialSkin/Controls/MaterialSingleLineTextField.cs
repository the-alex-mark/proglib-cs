    ...
    public class MaterialSingleLineTextField : Control, IMaterialControl
    {
        ...
        public MaterialSingleLineTextField()
        {
            ...
            BackColorChanged += (sender, args) =>
            {
                ...
                _baseTextBox.ForeColor = Parent.ForeColor;
            };
            ...
            _activeColor = Color.FromArgb(255, 128, 128);
            _inactiveColor = SystemColors.ControlDark;
        }

        private Font _font;
        private Color _activeColor, _inactiveColor;//, _foreColor;

        protected new Font Font
        {
            get { return _font; }
            set
            {
                _font = value;
                _baseTextBox.Font = _font;
                Invalidate();
            }
        }
        ...
        //    {
        //        _foreColor = value;
        //        _baseTextBox.ForeColor = _foreColor;
        //        Invalidate();
        //    }
        //}

        [Category("Appearance"), Description("Цвет активной линии")]
        ...
        [Category("Appearance"), Description("Цвет неактивной линии")]
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            {
                //No animation
                g.FillRectangle(_baseTextBox.Focused ? new SolidBrush(_activeColor) : new SolidBrush(_inactiveColor), _baseTextBox.Location.X, lineY, _baseTextBox.Width, _baseTextBox.Focused ? 2 : 1);
            }
            else
            {
                //Animate
                ...
                g.FillRectangle(new SolidBrush(_inactiveColor), _baseTextBox.Location.X, lineY, _baseTextBox.Width, 1);

                //Animated focus transition
                g.FillRectangle(new SolidBrush(_activeColor), animationStart - halfAnimationWidth, lineY, animationWidth, 2);
            }
        }

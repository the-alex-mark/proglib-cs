...
namespace System
{
	...
	public struct ValueTuple<T1, T2, T3, T4> : IEquatable<ValueTuple<T1, T2, T3, T4>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4>>, ITupleInternal
	{
		...
		{
			return ValueTuple<T1, T2, T3, T4>.s_t1Comparer.Equals(this.Item1, other.Item1) && ValueTuple<T1, T2, T3, T4>.s_t2Comparer.Equals(this.Item2, other.Item2) && ValueTuple<T1, T2, T3, T4>.s_t3Comparer.Equals(this.Item3, other.Item3) && ValueTuple<T1, T2, T3, T4>.s_t4Comparer.Equals(this.Item4, other.Item4);
		}
		...
		{
			return ValueTuple.CombineHashCodes(ValueTuple<T1, T2, T3, T4>.s_t1Comparer.GetHashCode(this.Item1), ValueTuple<T1, T2, T3, T4>.s_t2Comparer.GetHashCode(this.Item2), ValueTuple<T1, T2, T3, T4>.s_t3Comparer.GetHashCode(this.Item3), ValueTuple<T1, T2, T3, T4>.s_t4Comparer.GetHashCode(this.Item4));
		}

...
namespace System
{
	...
	public struct ValueTuple<T1, T2, T3, T4, T5, T6, T7> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, ITupleInternal
	{
		...
		{
			return ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t1Comparer.Equals(this.Item1, other.Item1) && ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t2Comparer.Equals(this.Item2, other.Item2) && ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t3Comparer.Equals(this.Item3, other.Item3) && ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t4Comparer.Equals(this.Item4, other.Item4) && ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t5Comparer.Equals(this.Item5, other.Item5) && ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t6Comparer.Equals(this.Item6, other.Item6) && ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t7Comparer.Equals(this.Item7, other.Item7);
		}
		...
		{
			return ValueTuple.CombineHashCodes(ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t1Comparer.GetHashCode(this.Item1), ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t2Comparer.GetHashCode(this.Item2), ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t3Comparer.GetHashCode(this.Item3), ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t4Comparer.GetHashCode(this.Item4), ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t5Comparer.GetHashCode(this.Item5), ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t6Comparer.GetHashCode(this.Item6), ValueTuple<T1, T2, T3, T4, T5, T6, T7>.s_t7Comparer.GetHashCode(this.Item7));
		}

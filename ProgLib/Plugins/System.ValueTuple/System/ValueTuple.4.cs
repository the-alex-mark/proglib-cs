...
namespace System
{
	...
	public struct ValueTuple<T1, T2, T3> : IEquatable<ValueTuple<T1, T2, T3>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3>>, ITupleInternal
	{
		...
		{
			return ValueTuple<T1, T2, T3>.s_t1Comparer.Equals(this.Item1, other.Item1) && ValueTuple<T1, T2, T3>.s_t2Comparer.Equals(this.Item2, other.Item2) && ValueTuple<T1, T2, T3>.s_t3Comparer.Equals(this.Item3, other.Item3);
		}
		...
		{
			return ValueTuple.CombineHashCodes(ValueTuple<T1, T2, T3>.s_t1Comparer.GetHashCode(this.Item1), ValueTuple<T1, T2, T3>.s_t2Comparer.GetHashCode(this.Item2), ValueTuple<T1, T2, T3>.s_t3Comparer.GetHashCode(this.Item3));
		}

...
namespace System
{
	...
	public struct ValueTuple<T1, T2, T3, T4, T5> : IEquatable<ValueTuple<T1, T2, T3, T4, T5>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5>>, ITupleInternal
	{
		...
		{
			return ValueTuple<T1, T2, T3, T4, T5>.s_t1Comparer.Equals(this.Item1, other.Item1) && ValueTuple<T1, T2, T3, T4, T5>.s_t2Comparer.Equals(this.Item2, other.Item2) && ValueTuple<T1, T2, T3, T4, T5>.s_t3Comparer.Equals(this.Item3, other.Item3) && ValueTuple<T1, T2, T3, T4, T5>.s_t4Comparer.Equals(this.Item4, other.Item4) && ValueTuple<T1, T2, T3, T4, T5>.s_t5Comparer.Equals(this.Item5, other.Item5);
		}

...
namespace System.Data.MySqlClient
{
  ...
  internal class MySqlStream
  {
    ...
    public void LoadPacket()
    {
      ...
      {
        throw new MySqlException(MySqlResources.ReadFromStreamFailed, true, ioex);
      }
    }
    ...
    public void SendPacket(MySqlPacket packet)
    {
      ...
      if ((ulong)length > maxPacketSize)
        throw new MySqlException(MySqlResources.QueryTooLarge, (int)MySqlErrorCode.PacketTooLarge);

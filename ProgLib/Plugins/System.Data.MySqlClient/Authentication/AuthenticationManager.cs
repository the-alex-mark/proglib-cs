...
namespace System.Data.MySqlClient.Authentication
{
    internal class AuthenticationPluginManager
    {
      ...
      {
        plugins["mysql_native_password"] = new PluginInfo("System.Data.MySqlClient.Authentication.MySqlNativePasswordPlugin");
        plugins["sha256_password"] = new PluginInfo("System.Data.MySqlClient.Authentication.Sha256AuthenticationPlugin");
#if !RT
        plugins["authentication_windows_client"] = new PluginInfo("System.Data.MySqlClient.Authentication.MySqlWindowsAuthenticationPlugin");
        plugins["caching_sha2_password"] = new PluginInfo("System.Data.MySqlClient.Authentication.CachingSha2AuthenticationPlugin");
      ...
      public static MySqlAuthenticationPlugin GetPlugin(string method)
      {
        if (!plugins.ContainsKey(method))
          throw new MySqlException(String.Format(MySqlResources.AuthenticationMethodNotSupported, method));

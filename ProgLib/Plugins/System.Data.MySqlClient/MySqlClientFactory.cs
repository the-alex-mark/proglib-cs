    ...
    private FieldInfo MySqlDbProviderServicesInstance
    {
      get
      {
        if (mySqlDbProviderServicesInstance == null)
        {
          ...
          fullName = String.Format("System.Data.MySqlClient.MySqlProviderServices, {0}", assemblyEf5Name);

          Type providerServicesType = Type.GetType(fullName, false);
          if (providerServicesType == null)
          {
            fullName = String.Format("System.Data.MySqlClient.MySqlProviderServices, {0}", assemblyName);

...
{
    /// <summary>
    /// Представляет набор команд данных и подключение базы данных, которые используются для заполнения <see cref="DataSet"/> и обновления источника данных.
    /// </summary>
    ...
    public sealed class MySqlDataAdapter : DbDataAdapter, IDbDataAdapter, IDataAdapter, ICloneable
    {
        ...
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="MySqlDataAdapter"/>.
        /// </summary>
        ...
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="MySqlDataAdapter"/> с помощью указанной команды <see cref="MySqlCommand"/> в качестве свойства <see cref="MySqlDataAdapter.SelectCommand"/>.
        /// </summary>
        /// <param name="selectCommand">Объект <see cref="MySqlCommand"/>, представляющий собой оператор SELECT или хранимую процедуру и заданный как свойство <see cref="MySqlDataAdapter.SelectCommand"/> объекта <see cref="MySqlDataAdapter"/></param>
        ...
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="MySqlDataAdapter"/> с помощью <see cref="MySqlDataAdapter.SelectCommand"/>.
        /// </summary>
        /// <param name="selectCommandText">Строка, представляющая собой оператор SQL SELECT или хранимую процедуру, используемую в свойстве <see cref="MySqlDataAdapter.SelectCommand"/> объекта <see cref="MySqlDataAdapter"/></param>
        /// <param name="connection"><see cref="MySqlConnection"/> представляет подключение</param>
        ...
        /// </summary>
        /// <param name="selectCommandText">Строка, представляющая собой оператор SQL SELECT или хранимую процедуру, используемую в свойстве <see cref="MySqlDataAdapter.SelectCommand"/> объекта <see cref="MySqlDataAdapter"/></param>
        /// <param name="selectConnString">Строка подключения</param>

...
namespace System.Data.MySqlClient
{
  internal class SchemaProvider
  {
    ...
    private static MySqlSchemaCollection GetReservedWords()
    {
      ...
      Stream str = typeof(SchemaProvider).GetTypeInfo().Assembly.GetManifestResourceStream("System.Data.MySqlClient.Properties.ReservedWords.txt");
#endif
    ...
    public virtual MySqlSchemaCollection GetUDF(string[] restrictions)
    {
      ...
      catch (MySqlException ex)
      {
        if (ex.Number != (int)MySqlErrorCode.TableAccessDenied)
          throw;
        throw new MySqlException(MySqlResources.UnableToEnumerateUDF, ex);
      }

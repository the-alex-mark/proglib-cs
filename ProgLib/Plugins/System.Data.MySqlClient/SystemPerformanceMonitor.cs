...
namespace System.Data.MySqlClient
{
  internal class SystemPerformanceMonitor : PerformanceMonitor
  {
    ...
    {
      string categoryName = MySqlResources.PerfMonCategoryName;
    ...
    private void EnsurePerfCategoryExist()
    {
      ...
      if (!PerformanceCounterCategory.Exists(MySqlResources.PerfMonCategoryName))
        PerformanceCounterCategory.Create(MySqlResources.PerfMonCategoryName, null, ccdc);
    }
#endif

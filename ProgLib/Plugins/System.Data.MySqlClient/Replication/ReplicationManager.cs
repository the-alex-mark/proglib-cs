...
namespace System.Data.MySqlClient.Replication
{
  /// <summary>
  ...
  internal static class ReplicationManager
  {
    ...
    internal static ReplicationServerGroup AddGroup(string name, string groupType, int retryTime)
    {
      if (string.IsNullOrEmpty(groupType))
        groupType = "System.Data.MySqlClient.Replication.ReplicationRoundRobinServerGroup";
    ...
    internal static ReplicationServerGroup GetGroup(string groupName)
    {
      ...
      if (group == null)
        throw new MySqlException(String.Format(MySqlResources.ReplicationGroupNotFound, groupName));
      return group;
    }
    ...
    internal static void GetNewConnection(string groupName, bool master, MySqlConnection connection)
    {
      do
      {
        lock (thisLock)
        {
          ...
          if (server == null)
            throw new MySqlException(MySqlResources.Replication_NoAvailableServer);

...
{
    /// <summary>
    /// Обеспечивает удобный способ создания и управления содержимым строк подключения с помощью класса <see cref="MySqlConnection"/>.
    /// </summary>
    public sealed partial class MySqlConnectionStringBuilder 
  {
    ...
    private MySqlConnectionStringOption GetOption(string key)
    {
      ...
      if (option == null)
        throw new ArgumentException(MySqlResources.KeywordNotSupported, key);
      else
        return option;
    }
    ...
    public void ValidateValue(ref object value)
    {
      ...
      if (valueType.Name == "String" ) {
        ...
        else if (BaseType == typeof(bool))
        {
          ...
          else throw new ArgumentException(String.Format(MySqlResources.ValueNotCorrectType, value));
          return;
        }
      }
      ...
      throw new ArgumentException(String.Format(MySqlResources.ValueNotCorrectType, value));
    }

  ...
  internal class ResultSet
  {
    ...
    public int GetOrdinal(string name)
    {
      ...
      throw new IndexOutOfRangeException(
          String.Format(MySqlResources.CouldNotFindColumnName, name));
    }
    ...
    public IMySqlValue this[int index]
    {
      ...
      {
        if (rowIndex < 0)
          throw new MySqlException(MySqlResources.AttemptToAccessBeforeRead);
        ...
        {
          if (index < seqIndex)
            throw new MySqlException(MySqlResources.ReadingPriorColumnUsingSeqAccess);
    ...
    private void ReadColumnData(bool outputParms)
    {
      ...
      if (outputParms)
      {
        ...
        rowIndex = 0;
        if (rowExists)
          throw new MySqlException(MySqlResources.MoreThanOneOPRow);
      }
    }
  }
}

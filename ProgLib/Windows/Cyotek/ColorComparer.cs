...
{
    /// <summary>
    /// Предоставляет доступ к операциям сравнения цветов.
    /// </summary>
    public static class ColorComparer
    {
        ...
        /// <summary>
        /// Сравнивает два цвета по яркости и возвращает указание их относительного порядка сортировки.
        /// </summary>
        ...
        /// <summary>
        /// Сравнивает два цвета по оттенкам и возвращает указание на их относительный порядок сортировки.
        /// </summary>
        /// <param name="x">A color to compare to y.</param>
        /// <param name="y">A color to compare to x.</param>
        ...
        /// <summary>
        /// Сравнивает два цвета по значению и возвращает указание на их относительный порядок сортировки.
        /// </summary>
        /// <param name="x">A color to compare to y.</param>
        /// <param name="y">A color to compare to x.</param>

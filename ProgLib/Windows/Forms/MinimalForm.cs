...
namespace ProgLib.Windows.Forms
{
    public class MaterialForm : Form
    {
        ...
        protected override void WndProc(ref Message e)
        {
            ...
            if (e.Msg == 0x0203) { MaximizeWindow(!_maximized); }
            else
        ...
        protected override CreateParams CreateParams
        {
            get
            {
                ...
                // 0x20000: запуск создания системного меню
                // 0x00080000: разрешить минимизацию с панели задач
                par.Style = par.Style | 0x20000 | 0x00080000; // Включите флаг стиля WS_MINIMIZEBOX
                return par;
            }
        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (Sizable)
            {
                // True, если мышь находится над дочерним элементом управления

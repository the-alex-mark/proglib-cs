...
namespace ProgLib.Windows.Forms
{
    ...
    /// Line of text
    /// </summary>
    public class Line : IList<TextCodeChar>
    {
        protected List<TextCodeChar> chars;
        ...
        public virtual string Text
        {
            get{
                ...
                foreach(TextCodeChar c in this)
                    sb.Append(c.c);
                return sb.ToString();
            }
        }
        ...
        public int IndexOf(TextCodeChar item)
        {
            return chars.IndexOf(item);
        }

        public void Insert(int index, TextCodeChar item)
        {
        ...
        public TextCodeChar this[int index]
        {
            get
            {
                return chars[index];
        ...
        public void Add(TextCodeChar item)
        {
            chars.Add(item);
        }
        ...
        public bool Contains(TextCodeChar item)
        {
            return chars.Contains(item);
        }

        public void CopyTo(TextCodeChar[] array, int arrayIndex)
        {
        ...
        public bool Remove(TextCodeChar item)
        {
            return chars.Remove(item);
        }

        public IEnumerator<TextCodeChar> GetEnumerator()
        {
        ...
        public virtual void AddRange(IEnumerable<TextCodeChar> collection)
        {

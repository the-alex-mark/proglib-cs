...
namespace ProgLib.Windows.Forms
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public SyntaxHighlighter(TextCode currentTb) {
        ...
        protected void RestoreBrackets(TextCode tb, char[] oldBrackets)
        {
        ...
        protected char[] RememberBrackets(TextCode tb)
        {

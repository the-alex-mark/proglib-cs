...
namespace ProgLib.Windows.Forms
{
    ...
    public class Range : IEnumerable<Place>
    {
        ...
        /// Constructor
        /// </summary>
        public Range(TextCode tb, int iStartChar, int iStartLine, int iEndChar, int iEndLine)
            : this(tb)
        {
        ...
        /// Constructor
        /// </summary>
        public Range(TextCode tb, Place start, Place end)
            : this(tb)
        {
            this.start = start;
            this.end = end;
        ...
        /// </summary>
        public Range(TextCode tb, int iLine)
            : this(tb)
        {
        ...
        /// </summary>
        public IEnumerable<TextCodeChar> Chars
        {
            get
            {
                if (ColumnSelectionMode)
            ...
            get
            {
                ...
                if (readonlyStyle != null)
                {
                    ...
                    if (IsEmpty)
                    {
                        ...
                        foreach (TextCodeChar c in Chars)

...
namespace ProgLib.Windows.Forms.Metro
{
    ...
    public partial class MetroRadioButton : System.Windows.Forms.RadioButton
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawEllipse(new Pen((Enabled) ? MetroPaint.BorderColor.CheckBox.Normal(_theme) : MetroPaint.BorderColor.CheckBox.Disabled(_theme), 1), _borderRectangle);

            if (_mouseState == MouseState.Hover)
            {
                e.Graphics.DrawEllipse(new Pen(MetroPaint.BorderColor.CheckBox.Hover(_theme), 1), _borderRectangle);
            ...
            if (Checked)
                e.Graphics.FillEllipse(new SolidBrush(_styleColor), new Rectangle(_borderRectangle.X + 3, _borderRectangle.Y + 3, 7, 7));

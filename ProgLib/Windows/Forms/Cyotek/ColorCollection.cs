...
{
    /// <summary>
    /// Представляет коллекцию цветов
    /// </summary>
    /// <remarks>
    /// 	<para>Коллекция цветов позволяет дублировать элементы.</para>
    /// 	<para>Доступ к элементам этой коллекции можно получить с помощью целочисленного индекса. Индексы в этой коллекции отсчитываются от нуля.</para>
    /// </remarks>
    public class ColorCollection : Collection<Color>, ICloneable, IEquatable<ColorCollection>
    {
      ...
      this.SwatchNames.RemoveAt(index);
        ...
        /// Сортирует элементы во всей коллекции %ColorCollection% в указанном порядке.
        /// </summary>

...
namespace ProgLib.Audio.Visualization
{
    ...
    public class Spectrum
    {
        ...
        public delegate void HandledEventArgs(Object sender, SpectrumEventArgs e);
        ...
        private void Getter(Object _object, EventArgs _elapsedEventArgs)
        {
            ...
            Leveling?.Invoke(this, new SpectrumEventArgs(_spectrumData));
            _spectrumData.Clear();
        ...
        /// <summary>
        /// Освобождает все ресурсы, используемые текущим экземпляром класса <see cref="Spectrum"/>.
        /// </summary>
        public void Free()
        {

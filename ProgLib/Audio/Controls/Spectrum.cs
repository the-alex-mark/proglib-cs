...
namespace ProgLib.Audio.Controls
{
    public class Spectrum : Control
    {
        public Spectrum()
        {
            this.Size = new Size(163, 78);
            this.BackProgressColor = Color.Transparent;
        ...
        public Int32 Count
        {
            get { return _progressBars.Count; }
            set { this.Create(value); }
        }

        public Color BackProgressColor
        {
            get;
            set;
        }
